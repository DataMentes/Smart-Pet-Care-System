...
class _SignupViewState extends State<SignupView> {
  ...
  void initState() {
    ...
    _pageController.addListener(() {
      // يمكنك وضع أي كود يعتمد على معرفة الصفحة الحالية هنا بأمان
    });
  }
  ...
  Future<void> _handleRequestOtp() async {
    ...
    try {
      final response = await _apiService.signupRequestOtp(
  ...
  // الخطوة الثانية: التحقق من الكود وإنشاء الحساب
  Future<void> _handleVerifyAndSignup() async {
    ...
    try {
      final signupData = {
        ...
        "fcm_token": "some_placeholder_token", // Placeholder for now
      };
